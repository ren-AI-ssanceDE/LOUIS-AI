...
import type { PrivateNeedSubItem } from '../../types.ts';

const YearSelector = ({ planningYears, selectedYears, onChange }: { planningYears: number, selectedYears: number[], onChange: (years: number[]) => void }) => {
        ...
        <div className="modal-overlay" onClick={onCancel}>
            <div className="modal-content" onClick={e => e.stopPropagation()}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder={t('modals.subitem.placeholder_name_private')} autoFocus />
                </div>
                 <div className="form-group">
...
export const EditModal = memo(({ subItem, onSave, onCancel, onDelete, planningYears }: { subItem: PrivateNeedSubItem, onSave: (data: { name: string, description: string, activeInYears: number[] }) => void, onCancel: () => void, onDelete: () => void, planningYears: number }) => {
    const { t } = useTranslation();
